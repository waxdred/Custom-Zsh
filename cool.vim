...
" NORMAL                               fg   bg 
let s:N1   = [ '#60fdff' , '#333333' , 81   , 236 ]
let s:N2   = [ '#60fdff' , '#333333' , 81   , 236 ]
let s:N3   = [ '#333333' , '#60fdff' , 236  , 81  ]
...
" INSERT
let s:I1 = [ '#333333' , '#60fdff' , 236 , 81  ]
let s:I2 = [ '#333333' , '#60fdff' , 236 , 81  ]
let s:I3 = [ '#60fdff' , '#333333' , 81  , 236 ]
...
" VISUAL
let s:V1 = [ '#60fdff' , '#333333' , 81  , 236 ]
let s:V2 = [ '#333333' , '#60fdff' , 236 , 81  ]
let s:V3 = [ '#60fdff' , '#333333' , 81  , 236 ]
